...
export default function sitemap(): MetadataRoute.Sitemap {
    ...
    return [
        ...
        {
            url: `${SITE_URL}/services/orthodontics`,
            lastModified: now,
            changeFrequency: "monthly",
            priority: 0.85,
        },
        {
            url: `${SITE_URL}/services/root-canal-treatment`,
            lastModified: now,
            changeFrequency: "monthly",
            priority: 0.85,
        },
        ...
        {
            url: `${SITE_URL}/services/digital-diagnostics`,
            lastModified: now,
            changeFrequency: "monthly",
            priority: 0.85,
        },
        {
            url: `${SITE_URL}/services/full-partial-dentures`,
            lastModified: now,
            changeFrequency: "monthly",
            priority: 0.85,
        },
        {
            url: `${SITE_URL}/services/extraction-replacement`,
            lastModified: now,
            changeFrequency: "monthly",
            priority: 0.85,
        },
        {
            url: `${SITE_URL}/services/restorative`,
            lastModified: now,
            changeFrequency: "monthly",
            priority: 0.85,
        },
