...
const FAQS = [
    ...
    {
        q: "Are you accepting new patients from Dhayari?",
        a: "Yes! We have many patients visiting from Dhayari due to our convenient location in Nanded City. You can walk in or book online — whichever is easier for you.",
    },
    {
...
const dhayariSchema = {
    ...
    priceRange: "₹₹",
    description: "Voted top dentist in Pune, serving Dhayari. Dr. Poonam Bambarkar (BDS, 15+ years) at Ingale Plaza, Nanded City. Root canals, implants, kids dentistry. Open 7 days.",
    ...
    return (
        <div className="bg-dental-cream min-h-screen flex flex-col font-sans">
            ...
            <main id="main-content" className="flex-1">
                ...
                <section
                    ref={heroRef}
                    aria-label="Dentistree — Best Dentist Near Dhayari"
                ...
                >
                    ...
                    >
                        <Image
                            ...
                            alt="Dr. Poonam Bambarkar at Dentistree Dental Clinic, near Dhayari"
                            fill
                    ...
                    <div className="relative z-10 container px-4 sm:px-6 pb-8 sm:pb-16 pt-32">
                        <div className="max-w-2xl">
                            ...
                            >
                                ...
                                Dhayari <br className="hidden sm:block" />
                            ...
                            >
                                ...
                                Root canals, implants, kids dentistry — just a short drive from Dhayari in Nanded City.
                            </motion.p>
                        ...
                        <div className="max-w-3xl mx-auto">
                            ...
                            <div className="text-center mb-12">
                                ...
                                <p className="mt-4 text-slate-500 text-base leading-relaxed">
                                    Why families from Dhayari have switched to Dentistree.
                                </p>
                            </div>
                    ...
                    <div className="container px-4 sm:px-6">
                        ...
                        >
                            <Image
                                ...
                                alt="Dentistree Clinic interior — Dhayari"
                                fill
