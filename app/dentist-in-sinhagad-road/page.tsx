...
const FAQS = [
    ...
    {
        q: "Where on Sinhagad Road are you located?",
        a: "We're conveniently located in Nanded City, right off Sinhagad Road at Ingale Plaza (Shop No. 1). There's plenty of parking available.",
    },
    {
...
const sinhagadRoadSchema = {
    ...
    priceRange: "₹₹",
    description: "Top-rated dentist on Sinhagad Road. Dr. Poonam Bambarkar (BDS, 15+ years) at Ingale Plaza, Nanded City. Root canals, implants, kids dentistry. Open 7 days.",
    ...
    return (
        <div className="bg-dental-cream min-h-screen flex flex-col font-sans">
            ...
            <main id="main-content" className="flex-1">
                ...
                <section
                    ref={heroRef}
                    aria-label="Dentistree — Best Dentist on Sinhagad Road"
                ...
                >
                    ...
                    >
                        <Image
                            ...
                            alt="Dr. Poonam Bambarkar at Dentistree Dental Clinic, Sinhagad Road"
                            fill
                    ...
                    <div className="relative z-10 container px-4 sm:px-6 pb-8 sm:pb-16 pt-32">
                        <div className="max-w-2xl">
                            ...
                            >
                                ...
                                Sinhagad Road <br className="hidden sm:block" />
                            ...
                            >
                                ...
                                Root canals, implants, kids dentistry — centrally located at Nanded City.
                            </motion.p>
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-10">
                            <div>
                                ...
                                >
                                    ...
                                    <br />
                                    <span className="text-dental-teal">on Sinhagad Road.</span>
                                </motion.h2>
                            </div>
                            <motion.div
                                initial={{ opacity: 0 }}
                        ...
                        <div className="max-w-3xl mx-auto">
                            ...
                            <div className="text-center mb-12">
                                ...
                                <p className="mt-4 text-slate-500 text-base leading-relaxed">
                                    Why families across Sinhagad Road have switched to Dentistree.
                                </p>
                            </div>
                    ...
                    <div className="container px-4 sm:px-6">
                        ...
                        >
                            <Image
                                ...
                                alt="Dentistree Clinic interior — Sinhagad Road"
                                fill
